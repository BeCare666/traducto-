...
// Global variables
  ...
  var choiceMyUserID = document.getElementById('choiceMyUserID');
  var modalclose = document.getElementById('modal-close');
  var pageId = document.getElementById('pageId');
  var beginId = document.getElementById('beginId');
  beginId.addEventListener('click', function(){
  choiceMyUserID.style.display = "block"

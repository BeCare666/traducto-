...
const firebaseConfig = {
  ...
  const UserConnectuser = localStorage.getItem("TraductoId");
      ...
      .then((snapshot) => {
        ...
        userListP.appendChild(userListUl);
            ...
            IdTogetwallet.addEventListener('click', function(){
                ...
                const UserConnectuserId = localStorage.getItem("TraductoId");
                const userRef = database.ref(`/traducteurs/${UserConnectuserId}`);
                const newData = {
                    COMMISSION: 0
                  };
